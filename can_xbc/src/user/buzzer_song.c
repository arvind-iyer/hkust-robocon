...
const MUSIC_NOTE START_UP[] = {{NOTE_G,6},{NOTE_B,6},{NOTE_D,6},{NOTE_G,6},{NOTE_END}};
const MUSIC_NOTE CONNECTED_SOUND[] = {{NOTE_D,5},{NOTE_G,5},{NOTE_B,5},{NOTE_B,5},{NOTE_END}};
...
const MUSIC_NOTE MARIO_BEGIN2[] = {
   {NOTE_Fs, 6}, {NOTE_REST}, {NOTE_Fs, 6}, {NOTE_Fs, 6}, {NOTE_REST}, {NOTE_REST}, {NOTE_Fs, 6}, {NOTE_Fs, 6},
  {NOTE_REST},{NOTE_REST},{NOTE_Fs, 6},{NOTE_REST},{NOTE_Fs, 6},{NOTE_Fs, 6},{NOTE_REST},{NOTE_REST},
   {NOTE_G, 6}, {NOTE_G, 6},{NOTE_REST},{NOTE_REST},{NOTE_REST},{NOTE_REST},{NOTE_REST},{NOTE_REST},
  {NOTE_G, 5}, {NOTE_G, 5},{NOTE_G, 5},{NOTE_END}
};
