...
#line 28 ".\\FWlib\\inc\\stm32f10x_dac.h"
...
#line 74 ".\\FWlib\\inc\\stm32f10x_dac.h"

#line 84 ".\\FWlib\\inc\\stm32f10x_dac.h"
...
#line 99 ".\\FWlib\\inc\\stm32f10x_dac.h"
...
#line 131 ".\\FWlib\\inc\\stm32f10x_dac.h"

#line 156 ".\\FWlib\\inc\\stm32f10x_dac.h"
...
#line 194 ".\\FWlib\\inc\\stm32f10x_dac.h"
...
#line 23 "FWlib\\SRC\\stm32f10x_dac.c"
...
void DAC_SetChannel1Data(uint32_t DAC_Align, uint16_t Data)
{
  ...
  *((volatile uint32_t *)((((uint32_t)0x40000000) + 0x7400) + ((uint32_t)0x00000008) + DAC_Align)) = (uint32_t)Data;
}
...
void DAC_SetChannel2Data(uint32_t DAC_Align, uint16_t Data)
{
  ...
  *((volatile uint32_t *)((((uint32_t)0x40000000) + 0x7400) + ((uint32_t)0x00000014) + DAC_Align)) = (uint32_t)Data;
}
...
void DAC_SetDualChannelData(uint32_t DAC_Align, uint16_t Data2, uint16_t Data1)
{
  ...
  *((volatile uint32_t *)((((uint32_t)0x40000000) + 0x7400) + ((uint32_t)0x00000020) + DAC_Align)) = data;
}
...
uint16_t DAC_GetDataOutputValue(uint32_t DAC_Channel)
{
  ...
  return (uint16_t) (*(volatile uint32_t*)((((uint32_t)0x40000000) + 0x7400) + ((uint32_t)0x0000002C) + ((uint32_t)DAC_Channel >> 2)));
}
