#line 1 "user\\Robocon_CANProtocol.c"
...
#line 14 "user\\Robocon_CANProtocol.c"

 
s32 Encoder_Count[16] = {0};			
s16	Robot_Coordinate_X = 0;						
s16 Robot_Coordinate_Y = 0;
s16 Robot_Angle = 0;
s16 Robot_Velocity_X = 0;						
...
CanTxMsg Tx_Queue[128];
u8 Tx_QueueHead = 0;
u8 Tx_QueueTail = 0;
u8 Tx_QueueCounter = 0;
CanRxMsg Rx_Queue[128];
u8 Rx_QueueHead = 0;
u8 Rx_QueueTail = 0;
...
CanTxMsg Motor_Velocity_Encoding(u32 Motor_ID, s32 vel, u8 Closed_Loop_Flag)
{
	...
	Raw_Data.Data[0] = 0xAA;								
	Raw_Data.Data[1] = Four_Bytes_Decomposition((u32)(vel), 0);		
	...
	Raw_Data.Data[5] = Closed_Loop_Flag;							
...
{
	Data_Field Raw_Data;
	Raw_Data.Data_Length = 7;
	Raw_Data.Data[0] = 0xBB;								
	Raw_Data.Data[1] = Two_Bytes_Decomposition(vel, 0);				
	Raw_Data.Data[2] = Two_Bytes_Decomposition(vel, 1); 
	Raw_Data.Data[3] = Four_Bytes_Decomposition(pos, 0);			
...
{
	Data_Field Raw_Data;
	Raw_Data.Data_Length = 3;
	Raw_Data.Data[0] = 0x44;							
...
CanTxMsg Gyro_Calibration_Encoding()
{
	...
	Raw_Data.Data[0] = 0xDD;
   	return General_Encoding(0x0A0, Raw_Data);
}
...
{
	Data_Field Raw_Data;
	Raw_Data.Data_Length = 5;
	Raw_Data.Data[0] = 0x22;
...
void Motor_Feedback_Decoding(CanRxMsg RxMessage)
{
	...
	{
		Encoder_Count[RxMessage.StdId - 0x0B0] = feedback;
	}
	else if(RxMessage.Data[0] ==  0x55)
	{
		test_data1 = feedback;	
	}
	else if(RxMessage.Data[0] ==  0x66)
	{
	   	test_data2 = feedback;
	}
	else if(RxMessage.Data[0] ==  0x77)
	{
	 	test_data3 = feedback;
	}
	else if(RxMessage.Data[0] ==  0x88)
	{
	  	test_data4 = feedback;
	}
}
...
u8 CAN_Tx_dequeue(void)
{
	...
	if(Tx_QueueCounter != 0)
	{
		...
		if(Tx_QueueHead == 128)
			Tx_QueueHead = 0;
		Tx_QueueCounter--;
		Tx_MailBox = CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);							
		while(CAN_TransmitStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),Tx_MailBox) != ((uint8_t)0x01) && retry--);	
		return 1;
	}
	else
		return 0;			
...
void CAN_Rx_Processing(CanRxMsg RxMessage)
{	
#line 554 "user\\Robocon_CANProtocol.c"
	if(RxMessage.StdId == 0x0A0)											
	{
		Gyro_Cmd_Decoding(RxMessage);
	}
	else if((RxMessage.StdId & 0x0F0) == 0x0B0)								
	
	{
		Motor_Cmd_Decoding(RxMessage);									
	}
...
void CAN_Tx_update(void)
{
	while(CAN_Tx_dequeue() != 0);
}

void CAN_Rx_update(void)
{
	while(CAN_Rx_dequeue() != 0);
}
...
void Send_Encoder(s32 Data)
{
	...
	u16 retry = 1000;
	u8 Tx_MailBox = 0;
	TxMsg = Encoder_Feedback_Encoding(0x0B0, Data);
	CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);
	Tx_MailBox = CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);							
	while(CAN_TransmitStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),Tx_MailBox) != ((uint8_t)0x01) && retry--);
}
...
void Calibration_Done(void)
{
	...
	u16 retry = 1000;
	u8 Tx_MailBox = 0;
	TxMsg = Cal_Feedback_Encoding(0x0B0);
	CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);
	Tx_MailBox = CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);							
	while(CAN_TransmitStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),Tx_MailBox) != ((uint8_t)0x01) && retry--);
}
...
void debug_data1(s32 data)
{
	...
	u16 retry = 1000;
	u8 Tx_MailBox = 0;
	TxMsg = Data1_Feedback_Encoding(0x0B1, data);
	CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);
	Tx_MailBox = CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);							
	while(CAN_TransmitStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),Tx_MailBox) != ((uint8_t)0x01) && retry--);
}
...
void debug_data2(s32 data)
{
	...
	u16 retry = 1000;
	u8 Tx_MailBox = 0;
	TxMsg = Data2_Feedback_Encoding(0x0B1, data);
	CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);
	Tx_MailBox = CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);							
	while(CAN_TransmitStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),Tx_MailBox) != ((uint8_t)0x01) && retry--);
}
...
void debug_data3(s32 data)
{
	...
	u16 retry = 1000;
	u8 Tx_MailBox = 0;
	TxMsg = Data3_Feedback_Encoding(0x0B1, data);
	CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);
	Tx_MailBox = CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);							
	while(CAN_TransmitStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),Tx_MailBox) != ((uint8_t)0x01) && retry--);
}
...
void debug_data4(s32 data)
{
	...
	u16 retry = 1000;
	u8 Tx_MailBox = 0;
	TxMsg = Data4_Feedback_Encoding(0x0B1, data);
	CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);
	Tx_MailBox = CAN_Transmit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &TxMsg);							
	while(CAN_TransmitStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),Tx_MailBox) != ((uint8_t)0x01) && retry--);
}
