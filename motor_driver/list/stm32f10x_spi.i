...
#line 23 "FWlib\\SRC\\stm32f10x_spi.c"
...
void I2S_Init(SPI_TypeDef* SPIx, I2S_InitTypeDef* I2S_InitStruct)
{
  ...
  if(I2S_InitStruct->I2S_AudioFreq == ((uint16_t)2))
  {
    i2sodd = (uint16_t)0;
    i2sdiv = (uint16_t)2;   
  }
  ...
  tmpreg |= (uint16_t)(((uint16_t)0x0800) | I2S_InitStruct->I2S_Mode |                   I2S_InitStruct->I2S_Standard | I2S_InitStruct->I2S_DataFormat |                   I2S_InitStruct->I2S_CPOL);
...
void I2S_StructInit(I2S_InitTypeDef* I2S_InitStruct)
{
  ...
  I2S_InitStruct->I2S_AudioFreq = ((uint16_t)2);
