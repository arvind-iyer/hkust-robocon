...
extern USART_TypeDef* COM_USART[5];
...
USART_TypeDef* COM_USART[5] = {((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))}; 
GPIO_TypeDef* COM_TX_PORT[5] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))}; 
GPIO_TypeDef* COM_RX_PORT[5] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))}; 
uc32 COM_USART_CLK[5] = {((uint32_t)0x00004000), ((uint32_t)0x00020000), ((uint32_t)0x00040000)};
uc32 COM_TX_PORT_CLK[5] = {((uint32_t)0x00000004), ((uint32_t)0x00000004), ((uint32_t)0x00000008)}; 
uc32 COM_RX_PORT_CLK[5] = {((uint32_t)0x00000004), ((uint32_t)0x00000004), ((uint32_t)0x00000008)};
uc16 COM_TX_PIN[5] = {((uint16_t)0x0200), ((uint16_t)0x0004), ((uint16_t)0x0400)};
uc16 COM_RX_PIN[5] = {((uint16_t)0x0400), ((uint16_t)0x0008), ((uint16_t)0x0800)};
uc16 COM_IRQ[5] = {USART1_IRQn, USART2_IRQn, USART3_IRQn};
...
{
	while (USART_GetFlagStatus(COM_USART[COM], ((uint16_t)0x0040)) == RESET); 
...
int fputc(int ch, FILE *f)
{
	...
	while (USART_GetFlagStatus(COM_USART[printf_COMx], ((uint16_t)0x0040)) == RESET);
