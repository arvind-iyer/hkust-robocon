...
void read_encoder(void)
{
	count = TIM_GetCounter(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)));
	if (count>62768)
	{
		s32 offset=count-30000;
		count=offset;
		TIM_SetCounter(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), offset);
		d_carrier++;
	}
	else if (count<2768)
	{
...
if(cali_done){
    ...
    ki1 = 0.45;
		...
		ii = 0.14;
		id = 0;
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0001),1);
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0002),0);
	}else{
		kp1 = 8;
    kp2 = 8;
    ki1 = 0.08;
		...
		ii = 0.2;
		id = 0;
		GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0002),1);
		GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0001),0);
	}	
}	
}
...
void vel_calculate_pwm(float p, float i, float d, u8 mode)
{
	...
	if (mode==0)
	{
		...
		if(current_input > 1100)	   current_input = 1100;
		if(current_input < -1100)   current_input = -1100;
	}
	else
	{
