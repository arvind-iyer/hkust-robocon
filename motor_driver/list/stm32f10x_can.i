...
#line 438 ".\\FWlib\\inc\\stm32f10x_can.h"
...
#line 23 "FWlib\\SRC\\stm32f10x_can.c"
...
#line 57 "FWlib\\SRC\\stm32f10x_can.c"
...
#line 76 "FWlib\\SRC\\stm32f10x_can.c"
...
void CAN_DeInit(CAN_TypeDef* CANx)
{
  ...
  {
    case (((uint32_t)0x40000000) + 0x6400):
...
uint8_t CAN_Init(CAN_TypeDef* CANx, CAN_InitTypeDef* CAN_InitStruct)
{
  ...
  while ((wait_ack != ((uint32_t)0x0000FFFF))&&((CANx->MSR & ((uint32_t)0x00000001)) != ((uint32_t)0x00000001)))
  {
    wait_ack++;
  }
