...
#line 2 "user\\configuration.c"
#line 3 "user\\configuration.c"


 
vu16 ADC_ConvertedValue[160];
vu16 ADC_ConvertedValue2[16];	 
u8 ADC_ConvertedValue2_raw[32];  
...
void DMA_Configuration()
{
	...
	DMA_InitStructure.DMA_MemoryBaseAddr = (u32)&ADC_ConvertedValue2_raw;				 
	DMA_InitStructure.DMA_DIR = ((uint32_t)0x00000000);								 
...
void ADC_Configuration()
{
	...
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x01), 2, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x02), 3, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x03), 4, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x04), 5, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x05), 6, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x06), 7, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x07), 8, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x08), 9, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x09), 10, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x0A), 11, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x0B), 12, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x0C), 13, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x0D), 14, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x0E), 15, ((uint8_t)0x07));
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x0F), 16, ((uint8_t)0x07));
...
void RCC_Configuration(void)
{
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00004000) | ((uint32_t)0x00000004) | ((uint32_t)0x00000008), ENABLE);
...
void GPIO_Configuration(void)
{
	GPIO_InitTypeDef GPIO_InitStructure;
 	...
 	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  	...
  	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x1000)|((uint16_t)0x4000);		
...
void USART_OUT16(USART_TypeDef* USARTx, uc16 *Data,uint16_t Len)
{
	...
	for(i=0; i<Len; i++)
	{
		...
		USART_OUT(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), &temp[0],2);
	}
}
