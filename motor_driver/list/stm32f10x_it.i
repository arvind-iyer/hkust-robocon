...
#line 6 "user\\stm32f10x_it.c"
#line 7 "user\\stm32f10x_it.c"
#line 8 "user\\stm32f10x_it.c"
...
#line 9 "user\\stm32f10x_it.c"

#line 16 "user\\stm32f10x_it.c"
...
{
	if(USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)),((uint16_t)0x0525))==SET)
	{	           	           
		rx_data = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))) & 0xff;
		...
		{
			if (data_cnt < 50) rx_buffer[data_cnt ++] = rx_data;
			if (last_data == 0xfe && rx_data == 0xff)
			{
				cmd_flag = 1;
				data_cnt -= 2;
				state = 0;
	...
	if(USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)),((uint16_t)0x0040))==SET)
	{	
	    if (tx_data_size != 0)
		{						  
			...
			{						 
				...
				tx_data_index++;
				if (tx_data_index>200-1) tx_data_index-=200;
	        	USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), tx_data);
    	  
			}
			else
			{
				USART_ITConfig(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0626), DISABLE);
				tx_data=tx_buffer[tx_data_index];
				tx_data_index++;
				if (tx_data_index>200-1) tx_data_index-=200;
	        	USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), tx_data);
