...
#line 2 "user\\algorithm.c"
#line 3 "user\\algorithm.c"

u16 Filtered_Data_Buffer[16];	 
...
void GUI_debug()
{	
	USART_TX_BYTE(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), 0xAA);	
	
	USART_TX_BYTE(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), final_result);
	USART_OUT16(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), &result[0], 32);	
}
...
void threshold_calculation()
{
	...
	u8 index = 0;
	u16 min_result = 10000;	
	u16 max_result = 0; 
	u16 min_high_result = 10000; 
	...
	if(possible_high_result_count == 0)	
	{
	...
	else if(possible_high_result_count < 16)	
	{
