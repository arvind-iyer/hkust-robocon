...
void RCC_Configuration(void){
  ...
  RCC_APB1PeriphClockCmd(((uint32_t)0x00000001)|
  						 ((uint32_t)0x00000002)|
						 ((uint32_t)0x00000004)|
						 ((uint32_t)0x00000008)|
						 ((uint32_t)0x00040000) , ENABLE);
...
void GPIO_init(void){
  ...
  GPIO_InitStructure.GPIO_Pin=((uint16_t)0x0010)|((uint16_t)0x0020)|((uint16_t)0x0040)|((uint16_t)0x0080)|((uint16_t)0x0001)|((uint16_t)0x0002);
...
void USART3_Configuration(void){
	...
	GPIO_PinRemapConfig(((uint32_t)0x00140010),ENABLE);
	...
	USART_ClockInit(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), &USART_ClockInitStructure);
...
void Encoder_init1(void)
{
	...
	encoder_TIM_TimeBaseStructure.TIM_Prescaler = 0x0; 
	encoder_TIM_TimeBaseStructure.TIM_Period = 65535;
	encoder_TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000);
	encoder_TIM_TimeBaseStructure.TIM_CounterMode = ((uint16_t)0x0000);  
	TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), &encoder_TIM_TimeBaseStructure);
	
	TIM_EncoderInterfaceConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0003),
	...
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->CNT = 32768;
...
void _ADC_Configuration(void)
{
	GPIO_InitTypeDef GPIO_InitStructure;
  	...
  	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0010)|((uint16_t)0x0020)|((uint16_t)0x0040)|((uint16_t)0x0080);
...
void _ADC_Initialization(void)
{
	...
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x06), 2, ((uint8_t)0x07));	
