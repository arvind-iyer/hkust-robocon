...
#define	WHEEL_BASE_W_VEL_RATIO								-350		//	80.0%
...
static const MOTOR_ID
	...
	MOTOR_TOP_LEFT 				= ROBOT=='C'?MOTOR2:MOTOR2,		//changed from MOTOR3				//MOTOR1 for C
	MOTOR_TOP_RIGHT 			= ROBOT=='C'?MOTOR3:MOTOR1;		//changed from MOTOR4				// MOTOR2 for C
