...
/**
	* @brief CRC16 convertor
	* @param buffer: Array of TWO one-byte variable
	* @param message: Array [msg_l] of the message to be encoded
	* @param msg_l: Array length of message
	*/
