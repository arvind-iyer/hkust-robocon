...
const MUSIC_NOTE SPEED_1[] = {{NOTE_A, 5}, {NOTE_END}};
const MUSIC_NOTE SPEED_2[] = {{NOTE_B, 5}, {NOTE_END}};
...
const MUSIC_NOTE SPEED_8[] = {{NOTE_A, 6}, {NOTE_END}};	// La
const MUSIC_NOTE SPEED_9[] = {{NOTE_B, 6}, {NOTE_END}};	// Ti
