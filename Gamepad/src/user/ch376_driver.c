...
void data_write_pp(u8 data){
	...
	gpio_data_out_init();
	GPIO_WriteBit(XBC_DATA_PORT_0_1, XBC_DATA_D0, (_BV(0) & data) >> 0);
	GPIO_WriteBit(XBC_DATA_PORT_0_1, XBC_DATA_D1, (_BV(1) & data) >> 1);
	GPIO_WriteBit(XBC_DATA_PORT_2_7, XBC_DATA_D2, (_BV(2) & data) >> 2);
	GPIO_WriteBit(XBC_DATA_PORT_2_7, XBC_DATA_D3, (_BV(3) & data) >> 3);
	GPIO_WriteBit(XBC_DATA_PORT_2_7, XBC_DATA_D4, (_BV(4) & data) >> 4);
	GPIO_WriteBit(XBC_DATA_PORT_2_7, XBC_DATA_D5, (_BV(5) & data) >> 5);
	GPIO_WriteBit(XBC_DATA_PORT_2_7, XBC_DATA_D6, (_BV(6) & data) >> 6);
	GPIO_WriteBit(XBC_DATA_PORT_2_7, XBC_DATA_D7, (_BV(7) & data) >> 7);
