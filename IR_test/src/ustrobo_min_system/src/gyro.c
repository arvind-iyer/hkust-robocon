		...
		switch (rx_state) {
			...
			case 4:
              ...
              /** TODO: Cancel the offset, varies along the robots **/
							gyro_pos.x = X_FLIP * gyro_pos_raw.x + (349 * int_sin(gyro_pos_raw.angle + 1902) / 10000 + 61);
              gyro_pos.y = Y_FLIP * gyro_pos_raw.y - (349 * int_sin(gyro_pos_raw.angle + 2800) / 10000 + 343);
